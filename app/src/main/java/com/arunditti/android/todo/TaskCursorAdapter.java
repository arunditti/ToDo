...
public class TaskCursorAdapter extends RecyclerView.Adapter<TaskCursorAdapter.TaskViewHolder> {
    ...
    public void onBindViewHolder(TaskViewHolder holder, int position) {
        ...
        int doneIndex = mCursor.getColumnIndex(TaskContract.TaskEntry.COLUMN_DONE);
    ...
    */
    ...
    class TaskViewHolder extends RecyclerView.ViewHolder {
        ...
        public TaskViewHolder(View itemView) {
            ...
            taskDescriptionView = (TextView) itemView.findViewById(R.id.tv_description);
            priorityView = (TextView) itemView.findViewById(R.id.tv_priority);
        }
    }
}